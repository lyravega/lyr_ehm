...
public class lyr_tooltip {
	public static class text {
		...
		public static final String[]
			...
			hasWeapons = {"Cannot be installed or removed as there are slots have weapons or inert shunts installed on them", "slots have weapons or inert shunts"},
			hasWeaponsOnAdaptedSlots = {"Cannot be removed as there are adapted slots have weapons or shunts installed on them", "adapted slots have weapons or shunts"},
			hasWeaponsOnConvertedSlots = {"Cannot be removed as there are converted slots have weapons or shunts installed on them", "converted slots have weapons or shunts"},
