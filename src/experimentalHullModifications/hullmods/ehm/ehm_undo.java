...
public final class ehm_undo extends _ehm_base {
	...
	public void addPostDescriptionSection(TooltipMakerAPI tooltip, HullSize hullSize, ShipAPI ship, float width, boolean isForModSpec) {
		...
		if (!this.isApplicableToShip(ship)) {
			...
			if (lyr_miscUtilities.hasHullModWithTag(ship, ehm_internals.hullmods.tags.experimental, null, false)) lyr_tooltipUtilities.addColourizedPara(tooltip, text.colourized.hasAnyExperimentalEnhanced, text.padding);
			else {
				if (lyr_miscUtilities.hasHullModWithTag(ship, ehm_internals.hullmods.tags.experimental, ehm_internals.hullmods.main.base, true)) lyr_tooltipUtilities.addColourizedPara(tooltip, text.colourized.hasAnyExperimental, text.padding);
	...
	public boolean isApplicableToShip(ShipAPI ship) {
		...
		if (lyr_miscUtilities.hasHullModWithTag(ship, ehm_internals.hullmods.tags.experimental, ehm_internals.hullmods.main.base, true)) return false;
	...
	public boolean showInRefitScreenModPickerFor(ShipAPI ship) {
		return (lyr_miscUtilities.hasBuiltInHullMod(ship, ehm_internals.hullmods.main.base)) ? true : false;
	}
}
