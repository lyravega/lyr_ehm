 ...
 * @author lyravega
 */
public final class ehm_ec_greenEngines extends _ehm_ec_base implements customizableMod {
	@Override
	public void updateData() {
		this.engineStyleId = engineStyleIds.custom;
		this.engineStyleSpec = this.newCustomEngineStyleSpec();
		this.hullModSpec.setDisplayName(lyr_ehm.lunaSettings.getLunaName(this.hullModSpecId));
